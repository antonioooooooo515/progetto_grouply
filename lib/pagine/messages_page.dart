...
class MessagesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (user == null) {
      return Center(child: Text(loc.t('toast_login_required')));
    }
...
class _LastMessagePreview extends StatelessWidget {
  ...
  const _LastMessagePreview({required this.groupId});
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snap) {
        ...
        final preview = text.isNotEmpty ? text : loc.t('chat_message_deleted_or_empty');
